  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>धरोहरसेतु — AI Heritage Travel Companion</p>

        <div style={styles.divider} />

        <h2 style={styles.heading}>Download the app to see details</h2>
        <p style={styles.description}>
          This spot is part of the interactive <strong>Dharohar Setu</strong> heritage guide.
        ...
        >
          <span>📥</span> Download Dharohar Setu App
        </a>
